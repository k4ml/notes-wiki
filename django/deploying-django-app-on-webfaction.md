# Deploying-Django-app-on-Webfaction
...
I use [Buildout](http://www.buildout.org/) to organize my Django project. This is how my `buildout.cfg` look alike:-
...
[Djangorecipe](http://pypi.python.org/pypi/djangorecipe) is used as the recipe to buildout on how to setup the actual Django project layout.
